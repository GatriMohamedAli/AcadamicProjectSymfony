 ...
 */
final class Version20220309003902 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, email, password, roles, is_verified, image, telephone, address, github_id FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) DEFAULT NULL, password VARCHAR(255) DEFAULT NULL, roles VARCHAR(255) NOT NULL, is_verified BOOLEAN DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, github_id VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, username, email, password, roles, is_verified, image, telephone, address, github_id) SELECT id, username, email, password, roles, is_verified, image, telephone, address, github_id FROM __temp__user');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, email, password, roles, is_verified, image, telephone, address, github_id FROM user');
        $this->addSql('DROP TABLE user');
        $this->addSql('CREATE TABLE user (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, username VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles VARCHAR(255) NOT NULL, is_verified BOOLEAN DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, github_id VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO user (id, username, email, password, roles, is_verified, image, telephone, address, github_id) SELECT id, username, email, password, roles, is_verified, image, telephone, address, github_id FROM __temp__user');
        $this->addSql('DROP TABLE __temp__user');
    }
}
